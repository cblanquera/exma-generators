export default class Validator {
  ...
  public static regex(value: string|number, regex: string|RegExp) { 
  ...
  //number
  public static gt(value: number|string, compare: number) { 
    return (Number(value) || 0) > compare;
  }
  public static ge(value: number|string, compare: number) { 
    return (Number(value) || 0) >= compare;
  }
  public static lt(value: number|string, compare: number) { 
    return (Number(value) || 0) < compare;
  }
  public static le(value: number|string, compare: number) { 
    return (Number(value) || 0) <= compare;
  }
